...
urlpatterns = [
    ...
    path('<str:action>/<str:detail>/<int:identity>/e-shop/', views.e_shop, name='e-shop'),
    path('<str:action>/<str:detail>/<int:identity>/e-shop-edit/', views.e_shop_edit, name='e-shop-edit'),
]
